...
export default function PortfolioShell() {
  ...
  return (
    <main>
      ...
      <footer><div className="footer-left"><span>© {new Date().getFullYear()} Ashish Kudu</span><a href="/privacy">Privacy</a></div><div className="footer-right"><span>Designed for engineering. Built for people.</span><small className="version-label">Version 1.1.5</small></div></footer>
